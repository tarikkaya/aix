          ...
          return currentRooms.map(room => {
              if (room.id === roomId) {
                  ...
                  const newUnit: Unit = {
                    ...
                    prompt: `I am a new ${type} unit. I will follow the coalition protocol. If I am configured with local providers, I will await a 'load' command for my main model and/or my embedding model. If I am configured with cloud providers, I will await a direct activation command from my Room Manager. My experience vector is managed by the RF Arbiter's global embedding engine.`,
                    ...
                    scaleVector: { enabled: false, provider: 'sqlite', path: `./aix_data/rooms/${roomId}/units/${newUnitId}/scale_vector.sqlite`, values: [] },
                    tools: [],
                  };

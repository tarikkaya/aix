                    ...
                    {unit.scaleVector?.enabled && (
                        <div className="space-y-4">
                            {unit.scaleVector.values && Array.isArray(unit.scaleVector.values) && unit.scaleVector.values.map((val, index) => (
                                <div key={val.id} className="p-3 bg-surface rounded-lg border border-border-color space-y-3">
                                    <div className="flex justify-between items-center">
                            ...
                            <button onClick={handleAddScaleValue} className="w-full p-2 bg-surface-light border border-dashed border-border-color rounded-md text-sm text-text-primary hover:bg-surface">Add Scale Value</button>
                        </div>
                    )}
                 </Section>
            )}

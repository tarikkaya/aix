...
export const initialRooms: Room[] = [
  {
    ...
    units: [
      ...
      { 
        ...
        prompt: "I am the Coalition Manager. I manage the coalition's structure by creating, updating, or deleting units and tools on command. Crucially, any new specialist unit I create is initialized with a core prompt instructing it to await activation from its Room Manager and to understand that its experience vector is written to by the RF Arbiter's global embedding engine. This ensures all new components adhere to the coalition's protocols.", 
